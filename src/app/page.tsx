    ...
    <div className="bg-emerald-300 text-emerald-800 font-serif w-full min-h-dvh p-9">
      <header className="flex w-full text-lg justify-between">
        ...
        <div className="flex gap-8">
          ...
          <button className="bg-emerald-800 px-4 py-2 rounded-full text-white hover:cursor-pointer">
            Cadastrar-se
          </button>
        </div>
      </header>
      <section className="flex w-full">
        <div className="w-1/2 my-auto p-10">
          ...
          <button className="text-white bg-emerald-800 text-lg py-2 px-4 rounded-full hover:cursor-pointer">
